...
class UserHistory extends Component {
    ...
    render() {
        ...
        console.log("child:", arrayHistories)
        return (
            <div className="user-history-container">
                ...
                <div className='filter-history'>
                    ...
                    <div className='div-search'>
                        <button className='btn-search' onClick={() => this.getHistoryByDay()}><i class="fas fa-search"></i></button>
                        <div className='search-name'><FormattedMessage id="history-web.filter.btn-search"/></div>
                    </div>
                </div>
